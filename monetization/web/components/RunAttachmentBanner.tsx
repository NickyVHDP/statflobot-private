  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2.5 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-white">Run diagnostics selected</p>
      ...
      <p className="mt-3 text-xs text-slate-500">
        The technical log stays private and will be attached server-side when you send this report.
      </p>
    </div>
  );
}
